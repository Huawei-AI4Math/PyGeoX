...
export WANDB_PROJECT="PyGeoX-RL-QWEN-8b-SPARSE"
...
export RAY_object_spilling_config='{"type":"filesystem","params":{"directory_path":"/tmp/ray_spill_sparse"}}'
# -----------------------------
...
unset RAY_ADDRESS
rm -rf /tmp/ray_spill_sparse; mkdir -p /tmp/ray_spill_sparse
...
python3 -m openrlhf.cli.train_ppo_ray \
   ...
   --remote_rm_url $PROJECT_ROOT/model_training/run_commands/reward_func_sparse.py \
   --save_path $PROJECT_ROOT/model_training/RL_checkpoint_8b_sparse \
   --ckpt_path $PROJECT_ROOT/model_training/RL_checkpoint_8b_sparse \
   --load_checkpoint \
   --save_steps 3 \
   --max_ckpt_num 25 \
   ...
   --wandb_project "PyGeoX-RL-LLM-SPARSE-REWARD-8b"
