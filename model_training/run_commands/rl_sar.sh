...
export WANDB_PROJECT="PyGeoX-RL-QWEN-8b-SAR"
...
export RAY_object_spilling_config='{"type":"filesystem","params":{"directory_path":"/tmp/ray_spill_sar"}}'
# -----------------------------
...
unset RAY_ADDRESS
rm -rf /tmp/ray_spill_sar; mkdir -p /tmp/ray_spill_sar
...
python3 -m openrlhf.cli.train_ppo_ray \
   ...
   --remote_rm_url $PROJECT_ROOT/model_training/run_commands/reward_func_sar.py \
   --save_path $PROJECT_ROOT/model_training/RL_checkpoint_8b_SAR \
   --ckpt_path $PROJECT_ROOT/model_training/RL_checkpoint_8b_SAR \
   --load_checkpoint \
   --save_steps 3 \
   --max_ckpt_num 25 \
   ...
   --wandb_project "PyGeoX-RL-LLM-SAR-REWARD-8b"
