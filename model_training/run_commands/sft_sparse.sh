...
# ============================================================================
# MS-Swift SFT Training Script for Sparse Models (Full Parameter Fine-Tuning)
# 
...
export WANDB_PROJECT="qwen3-8b-SFT-Sparse"
...
# For sparse training, you may want to use a filtered dataset with high-quality samples
DATASET_PATH="${PROJECT_ROOT}/model_training/old_data/rejection_sampling/rs_sparse_cleaned.jsonl"
OUTPUT_DIR="${PROJECT_ROOT}/model_training/sft_training/SFT_sparse"
...
RUN_NAME="SFT_sparse_run1"  # Wandb run name (for tracking experiments)

# Wandb Tags (optional, for filtering runs)
# Set as environment variable for wandb to pick up
# export WANDB_TAGS="sparse,sft,qwen3-8b"

# Wandb Notes (optional, for run description)
# Set as environment variable for wandb to pick up
# export WANDB_NOTES="SFT training for sparse reward model"
# ========================================================
